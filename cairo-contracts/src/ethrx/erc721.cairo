/// This is a modified version of this contract: https://github.com/OpenZeppelin/cairo-contracts/blob/cairo-2/src/openzeppelin/tests/token/test_erc721.cairo
...
mod ERC721 {
    ...
    use novemberfork::openzeppelin::account;
